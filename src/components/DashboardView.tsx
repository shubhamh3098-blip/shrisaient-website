...
export const DashboardView: React.FC<DashboardViewProps> = ({
  ...
  return (
    <div className="max-w-7xl mx-auto px-3 sm:px-6 py-4 sm:py-6 space-y-4 sm:space-y-6">
      {/* Top Banner */}
      <div className="tactile-card rounded-2xl p-4 sm:p-6 border border-[var(--tactile-border)] flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="space-y-1">
          ...
          <h1 className="text-xl sm:text-3xl font-bold tracking-tight text-[var(--tactile-text-heading)]">
            {settings.businessName}
          </h1>
        ...
        <div className="flex flex-wrap sm:flex-nowrap items-center gap-2 sm:gap-3 w-full sm:w-auto">
          <button
            ...
            className="flex-1 sm:flex-none px-3.5 py-2 sm:px-4 sm:py-2.5 rounded-xl tactile-btn-primary font-semibold text-xs sm:text-sm shadow-md transition flex items-center justify-center gap-1.5 sm:gap-2 cursor-pointer"
          >
          ...
          <button
            ...
            className="flex-1 sm:flex-none px-3.5 py-2 sm:px-4 sm:py-2.5 rounded-xl tactile-btn-secondary text-[var(--tactile-text-main)] font-medium text-xs sm:text-sm transition flex items-center justify-center gap-1.5 sm:gap-2 cursor-pointer"
          >

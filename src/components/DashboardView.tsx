...
export const DashboardView: React.FC<DashboardViewProps> = ({
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 space-y-6">
      {/* Top Banner */}
      <div className="bg-gradient-to-r from-[#0A1124] to-[#152347] text-white rounded-2xl p-6 shadow-sm border border-slate-800 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="px-4 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-semibold text-sm shadow-md shadow-blue-600/30 transition flex items-center gap-2 cursor-pointer"
          >
          ...
          <button
            ...
            className="px-4 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 font-medium text-sm border border-slate-700 transition flex items-center gap-2 cursor-pointer"
          >
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-xs flex flex-col justify-between">
          ...
          <div className="mt-4">
            ...
            <button
              ...
              className="text-xs text-blue-600 hover:underline font-medium mt-1 inline-flex items-center gap-1 cursor-pointer"
            >
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl border border-slate-200 shadow-xs p-5 space-y-4">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            <div>
              ...
              <p className="text-xs text-slate-500">Latest sales and cash collection entries</p>
            </div>
            <button
                ...
                {recentTransactions.map((tx) => (
                  <tr key={tx.id} className="hover:bg-slate-50/70 transition">
                    <td className="py-3 px-3">
                      <p className="font-semibold text-slate-900 font-mono">{tx.invoiceNo}</p>
                    ...
                    <td className="py-3 px-3 max-w-[160px] truncate text-slate-600">
                      {tx.itemDetails}
                    </td>
                    <td className="py-3 px-3">
        ...
        <div className="space-y-6">
            ...
            {lowStockItems.length > 0 ? (
              <div className="space-y-2.5">
                {lowStockItems.map((item) => (
                  <div
                    key={item.id}
                    className="p-2.5 rounded-xl bg-amber-50/60 border border-amber-200/70 flex items-center justify-between text-xs"
                  >
                    <div>
                    ...
                    <button
                      ...
                      className="px-2.5 py-1 bg-white border border-amber-300 text-amber-800 rounded-lg font-medium text-[11px] hover:bg-amber-100 cursor-pointer"
                    >
                      Restock
                    </button>
                  </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-xs p-5 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2.5 text-xs">
              <button
                onClick={() => onNavigate('customers')}
                className="p-3 rounded-xl border border-slate-200 bg-slate-50 hover:bg-blue-50 hover:border-blue-200 text-left transition cursor-pointer"
              >
                <Users className="w-4 h-4 text-blue-600 mb-1" />
                <p className="font-semibold text-slate-900">Khata Book</p>
              ...
              >
                ...
                <p className="text-[10px] text-slate-500">{stock.length} Products</p>
              </button>
              <button
              ...
              >
                ...
                <p className="text-[10px] text-slate-500">Daily shop costs</p>
              </button>
              <button
              ...
              >
                ...
                <p className="text-[10px] text-slate-500">Export JSON</p>
              </button>
            </div>
          </div>
        </div>

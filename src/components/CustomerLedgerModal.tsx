    ...
    <div className="fixed inset-0 z-50 bg-black/75 backdrop-blur-xs flex items-end sm:items-center justify-center p-0 sm:p-4 overflow-y-auto print:p-0 print:m-0 print:static print:bg-white print:overflow-visible">
      <div className="bg-white rounded-t-3xl sm:rounded-2xl max-w-4xl w-full shadow-2xl overflow-hidden border border-slate-200 animate-fade-in flex flex-col h-[95vh] sm:h-auto sm:max-h-[92vh] print:h-auto print:max-h-none print:shadow-none print:border-none print:rounded-none print:my-0 print:overflow-visible">
        ...
        <div id="printable-ledger" className="p-4 sm:p-6 overflow-y-auto flex-1 space-y-5 bg-white text-slate-900 print:overflow-visible print:p-2 print:space-y-3">
          ...
          <div className="hidden sm:block print:block border border-slate-200 rounded-xl overflow-hidden shadow-2xs print:border-slate-300 print:shadow-none print:break-inside-auto">
        ...
        <div className="sm:hidden no-print p-2.5 bg-white border-t border-slate-200 flex items-center gap-2 shrink-0 shadow-lg">
          <button
            type="button"
            onClick={handleShareWhatsApp}
            className="flex-1 py-2.5 px-3 rounded-xl bg-[#25D366] hover:bg-[#20ba59] active:scale-95 text-slate-950 font-black text-xs flex items-center justify-center gap-2 shadow-xs cursor-pointer"
          >
            <Share2 className="w-4 h-4 stroke-[2.5]" />
            <span>WhatsApp वर हिशोब पाठवा</span>
          </button>
          <button
            type="button"
            onClick={handlePrint}
            className="py-2.5 px-3.5 rounded-xl bg-slate-900 hover:bg-slate-800 active:scale-95 text-white font-bold text-xs flex items-center justify-center gap-1.5 shadow-xs cursor-pointer"
          >

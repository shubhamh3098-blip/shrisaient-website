          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 border-b border-black text-[10px]">
            ...
            <div className="p-2 border-r border-black">
              ...
              <p className="text-slate-700 mt-0.5">
                {purchase.buyerAddress || 'WARD NO 1, NEAR DATEY SABHAGRUH, Arvi Road, WARDHA NEAR DATEY SABHAGRUH, 442001 MAHARASHTRA INDIA'}
              </p>
              <p className="mt-1 text-slate-700">
                <span className="font-bold">Phone :</span> {settings.phone || '8600122978, 8600122798'}
              </p>
              <p className="text-slate-700">
                <span className="font-bold">Email :</span> {settings.email || 'non01@gmail'}
              </p>

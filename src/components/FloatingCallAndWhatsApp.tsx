      ...
      <div className="fixed bottom-20 sm:bottom-6 left-3 sm:left-6 z-40 no-print">
        ...
        >
          ...
          <div className="flex flex-col text-left">
            ...
            <span className="text-[10px] text-slate-400 hidden sm:inline leading-tight font-mono">
              {primaryPhone}
            </span>
          </div>
        </a>
      ...
      <div className="fixed bottom-20 sm:bottom-6 right-3 sm:right-6 z-40 no-print">
        ...
        >
          <div className="flex flex-col text-right">
            ...
            <span className="text-[10px] text-emerald-200 hidden sm:inline leading-tight">
              Instant Chat
            </span>
          </div>
          <div className="relative flex items-center justify-center">

  ...
  return (
    <div className="space-y-6 pb-20">
      ...
      <div className="bg-white dark:bg-slate-900 p-4 sm:p-5 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-4">
        ...
        {/* Discrepancy / Gadbad Alert Banner */}
        {totalDiscrepanciesCount > 0 && (
          <div className="p-3.5 rounded-2xl bg-gradient-to-r from-amber-50 to-rose-50 border border-amber-200 dark:from-amber-950/40 dark:to-rose-950/40 dark:border-amber-800/60 flex flex-col sm:flex-row sm:items-center justify-between gap-3 shadow-2xs">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <p className="text-xs font-bold text-amber-950 dark:text-amber-200">
                  ⚠️ इंपोर्ट केलेल्या डेटामध्ये <span className="underline decoration-rose-500 font-black text-rose-700 dark:text-rose-400">{totalDiscrepanciesCount} नोंदींमध्ये त्रुटी / गडबड</span> आढळली आहे!
                </p>
                <p className="text-[11px] text-amber-800 dark:text-amber-300/80">
                  (उदा. नाव रिकामे, रक्कम ₹0, अमान्य कार्ड नंबर किंवा पत्ता/गाव नोंद नाही)
                </p>
              </div>
            </div>
            <button
              ...
              className={`px-3.5 py-1.5 rounded-xl text-xs font-bold transition flex items-center justify-center gap-1.5 cursor-pointer shrink-0 ${
            ...
            >
              ...
              <span>{activeCategory === 'discrepancies' ? 'सर्व नोंदी दाखवा' : 'फक्त गडबड असलेल्या नोंदी फिल्टर करा'}</span>
            </button>
          </div>
        )}
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-1 text-sm sm:text-xs">
          {[
            ...
            { id: 'discrepancies', label: '⚠️ गडबड / दुरुस्ती नोंदी', count: totalDiscrepanciesCount, icon: AlertTriangle, isWarning: totalDiscrepanciesCount > 0 },
